...
{
    public class TmdbMovieWatchProvidersService
    {
        ...
        public async Task<TMDB_Providers> GetProviders(HttpClient http, ISyncSessionStorageService storage, string id)
        {
            ...
            return await http.GetSession<TMDB_Providers>(storage, BaseUri + $"movie/{id}/watch/providers".ConfigureParameters(parameter));
        }
    }
}